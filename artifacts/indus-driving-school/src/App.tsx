  ...
  return (
    <>
      <style>{`
        ...
        .whatsapp-btn {
          animation: ${visible ? 'bounceIn 0.8s ease forwards, float 3s ease-in-out 1s infinite' : 'none'};
          opacity: ${visible ? 1 : 0};
        }
        .whatsapp-btn:hover {
        ...
        .ping-2 {
          animation: pingDelay 2s cubic-bezier(0,0,0.2,1) infinite 0.6s;
        }
        .whatsapp-tooltip {
          opacity: 0;
