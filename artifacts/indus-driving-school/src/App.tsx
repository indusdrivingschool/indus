    ...
    <>
      <style>{`
        ...
        .wa-ring-2 {
          ...
          border-radius: 50%;
          background-color: #25D366;
          animation: wa-ping 2s cubic-bezier(0,0,0.2,1) infinite 0.7s;
          opacity: 0.3;
        }
        .wa-icon {
          position: relative;
      ...
      <div className="wa-wrapper">
        <div className="wa-tooltip">💬 Book a lesson!</div>
        ...
        >
          ...
          <svg className="wa-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="32" height="32">
