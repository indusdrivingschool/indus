...
function WhatsAppButton() {
  return (
    ...
    >
      ...
      <style>{`@keyframes waping{0%{transform:scale(1);opacity:0.6}100%{transform:scale(2.3);opacity:0}}@keyframes wafloat{0%,100%{transform:translateY(0px)}50%{transform:translateY(-8px)}}`}</style>
    </a>
  );
}
