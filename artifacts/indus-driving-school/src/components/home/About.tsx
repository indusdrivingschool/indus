        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Master the Road with Expert Instruction
            </h3>
          ...
          <div className="grid gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-card p-6 rounded-2xl border border-border shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 group"
              >
